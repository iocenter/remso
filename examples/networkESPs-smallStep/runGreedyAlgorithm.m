...
%     flowScale = [];
    ...
    highestDens = 0.6*str.water_dens + 0.4*str.oil_dens; % maximum of 0.6 water cut (for this scenario, not limited in practice)
...
%     ubv = repmat({[ubvS;  inf]},totalPredictionSteps,1);      
    ...
    plotSol = @(x,u,v,d,varargin) plotSolution( x,u,v,d, lbv, ubv, lbu, ubu, ss,obj,times,xScale,cellControlScales,vScale, nScale, ...
                ...
                'plotSchedules',false,'pF',fPlot,'sF',fPlot, 'fixedWells', fixedWells, 'extremePoints', extremePoints, 'plotCumulativeObjective', true, 'qlMin', qlMin,  'qlMax', qlMax, 'nStages', numStages, varargin{:});
