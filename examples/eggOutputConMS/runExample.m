...
maxInj = struct('ORAT',inf*meter^3/day,'WRAT',500*meter^3/day,'GRAT',inf*meter^3/day,'BHP',inf*barsa);
...
maxState = struct('pressure',inf*barsa,'sW',0.85);
minState = struct('pressure',380*barsa,'sW',0.1);
