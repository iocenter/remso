...
networkJointObj = arroba(@networkJointNPVConstraints,[1,2], ...
                         {nCells, netSol, freqScale, pressureScale, ...
                         flowScale, numStages, baseFreq, qlMin, qlMax, ...
                         'scale',1e-07, 'OilPrice', 100, 'WaterProductionCost', 5, ...
                         'WaterInjectionCost', 0.1, 'DiscountFactor', 0, ...
                         'sign',-1, 'dpFunction', @dpBeggsBrillJDJ, ...
                         'finiteDiff', true, 'forwardGradient', true, 'extremePoints', extremePoints},true);
