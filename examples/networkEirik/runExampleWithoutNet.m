...
algFun = concatenateMrstTargets([stepNPV],false, [numel(nScale); 1]);
...
plotSol = @(x,u,v,d,varargin) plotSolution( x,u,v,d, lbv, ubv, lbu, ubu, ss,obj,times,xScale,cellControlScales,vScale, nScale, cellControlScalesPlot,controlSchedules,wellSol,ulbPlob,uubPlot,[uLimLb,uLimUb],minState,maxState,'simulate',simFunc,'plotWellSols',true, 'plotNetsol', false, 'plotNetControls', false, 'plotSchedules',false,'pF',fPlot,'sF',fPlot,varargin{:});
