...
for j = 1:k
    ...
    [mu.dx,to] = extractDuals(dual,to,nc{j}.lb.x,newCons{j}.lb.x,xDims,mu.dx,first,-1);    
	[mu.dx,to] = extractDuals(dual,to,nc{j}.ub.x,newCons{j}.ub.x,xDims,mu.dx,false, 1);

    [mu.dv,to] = extractDuals(dual,to,nc{j}.lb.v,newCons{j}.lb.v,vDims,mu.dv,first,-1);   
	[mu.dv,to] = extractDuals(dual,to,nc{j}.ub.v,newCons{j}.ub.v,vDims,mu.dv,false, 1);
...
function [mubz,to] = extractDuals(dual,to,ncbz,newConsbz,zDims,mubz,first,sign)
