...
%
%
opt = struct('gradients',false,'xLeftSeed',[],'vLeftSeed',[],'guessX',[],'guessV',[],'xRightSeed',[],'uRightSeed',[],'simVars',[],'withAlgs',false,'printCounter',false);
...
if opt.printCounter
    ...
    [xs,vs,JacStep,convergence,simVars] = cellfun(@(...
        stepk,xStartk,uslicedk,xLeftSeedk,vLeftSeedk,guessXk,guessVk,xRightSeedk,uRightSeedSlicedk,simVarsk)...
        callArroba(stepk,{xStartk,uslicedk},...
        'gradients',gradientFlag,...
        'xLeftSeed',xLeftSeedk,...
        'vLeftSeed',vLeftSeedk,...
        'guessX',guessXk,...
        'guessV',guessVk,...
        'xRightSeeds',xRightSeedk,...
        'uRightSeeds',uRightSeedSlicedk,...
        'simVars',simVarsk),...
        step, xStart ,usliced ,xLeftSeed' ,vLeftSeed' ,guessX ,guessV ,xRightSeed ,uRightSeedSliced ,simVars ...
        ,'UniformOutput',false);
    
        converged = cellfun(@(c)c.converged,convergence);
