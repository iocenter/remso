function [adjRes,RHS] = solveAdjointTransportSystem(G, S, W, rock, fluid, simRes, adjRes, obj, varargin)
...
-Trick to get senstivities with respect to the initial conditions
-Return the RHS
%}
...
if curStep < numSteps
    ...
    for wellNr = 1:numW
        ...
        RHS = RHS + w.S.C'*bsxfun(@times, ( (w.S.C*dim).*q ),(w.S.B*l_q) );
    end
end
