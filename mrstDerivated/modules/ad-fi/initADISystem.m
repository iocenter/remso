...
opt = struct('tol_mb',              1e-7,...
             ...
             'cpr',                 false,...
             'cprAdjoint',          false,...                          
             'itLinearSolver',      false,...
             'itSolverFwdADI',      false,...
             'itSolverAdjADI',      false,...
             'cprEllipticSolver',   [],...
             'directSolver',        [],...
             'cprBlockInvert',      true,...
             'relaxation',          1,...
...
system.nonlinear.itLinearSolver = opt.itLinearSolver;
system.nonlinear.cpr            = opt.cpr;
system.nonlinear.cprAdjoint     = opt.cprAdjoint;
system.nonlinear.itSolverFwdADI = opt.itSolverFwdADI;
system.nonlinear.itSolverAdjADI = opt.itSolverAdjADI;
