function objs = finalStepVars(forwardStates,schedule,p, varargin)
...
if ~comp.gas && ~comp.polymer && ~(comp.T || comp.MI)
    ...
    objs = finalStepVarsOW(forwardStates,schedule,p,...
...
elseif comp.gas && comp.oil && comp.water
    ...
    objs = finalStepVarsOWG(forwardStates,schedule,p,...
        opt.fluid,...
