function [x,v,Jac,convergence,simVars] = mrstStep(x0,u,simulator,schedule,reservoirP,varargin)
%
...
%
%
opt = struct('gradients',false,'xLeftSeed',[],'vLeftSeed',[],'xRightSeeds',[],'uRightSeeds',[],'guessX',[],'guessV',[],'uScale',[],'saveJacobians',true,'simVars',[],'algFun',[], 'fixedWells', []);
...
target1 = arroba(@model.finalStepVars,[1,2],{...
...
[f,J,convergence,simVars] = targetMrstStep(x0,u,target,simulator,schedule,reservoirP,...
