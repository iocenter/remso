...
opt = struct('simulate',[],'simFlag',false,'plotWellSols',true, 'plotNetsol', true, 'numNetConstraints', 0, 'plotNetControls', true, 'numNetControls', 0, 'plotSchedules',true,'plotObjective',true,'pF',@(x)x,'sF',@(x)x,'figN',1000,'wc',false,'reservoirP',[],'plotSweep',false,...
    'activeComponents',struct('oil',1,'water',1,'gas',0,'polymer',0,'disgas',0,'vapoil',0,'T',0,'MI',0),...% default OW
    'fluid',[]);
