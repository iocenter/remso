function [dpds_tot,f_work,Z] =  dpBeggsBrillJDJ(E, qoE, qwE, qgE, pV,f_work,Z)
...
[dpVector,f_work,Z] = Beggs_Brill_dpds(s,pV,[],alpha,d,e,oil,q_sc,rho_sc,s_in,s_out,T_in,T_out,hasSurfaceGas,f_work,Z);
dpds_tot = dpVector(1);
end
